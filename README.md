# SNOMED CT Database Loader for Azure

This repository provides scripts specifically for building and maintaining a **SNOMED CT database instance on Azure** using the **Monolith** and **UK Primary Care** snapshots released via **NHS TRUD**. I created this in an effort to learn how to maintain and use the different downloads available from the TRUD.
